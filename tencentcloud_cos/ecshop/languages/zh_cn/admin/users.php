...
$_LANG['notice_pay_points'] = '消费积分是一种站内货币，允许用户在购物时支付一定比例的积分进行抵扣。';
...
$_LANG['email_exists'] = '该邮箱已经存在！';
$_LANG['edit_user_failed'] = '修改会员资料失败！';
$_LANG['invalid_email'] = '输入了非法的邮箱！';
$_LANG['update_success'] = '编辑用户信息成功！';
...
$_LANG['remove_cancel'] = '不，我不想删除该会员账号。';
...
$_LANG['email_invalid'] = '无效的邮箱！';
$_LANG['email_not_allow'] = '邮箱不允许！';
...
$_LANG['js_languages']['invalid_email'] = '没有输入邮箱或者输入了一个无效的邮箱！';

...
$_LANG['notice_pay_points'] = '消費積分是一種站內貨幣，允許用戶在購物時支付一定比例的積分進行抵扣。';
...
$_LANG['email_exists'] = '該郵箱已經存在！';
$_LANG['edit_user_failed'] = '修改會員資料失敗！';
$_LANG['invalid_email'] = '輸入了非法的郵箱！';
...
$_LANG['email_invalid'] = '無效的郵箱！';
$_LANG['email_not_allow'] = '郵箱不允許！';
...
$_LANG['js_languages']['invalid_email'] = '沒有輸入郵箱或者輸入了一個無效的郵箱！';

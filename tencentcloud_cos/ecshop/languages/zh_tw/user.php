...
$_LANG['label_account_bind'] = '賬戶綁定';
$_LANG['bind_wechat'] = '綁定微信';
$_LANG['bind_wechat_acc'] = '綁定微信賬戶';
$_LANG['bind_oldAccount'] = '綁定老賬戶';
$_LANG['Unbind'] = '解除綁定';
$_LANG['sweep_bind_wechat'] = '掃一掃，綁定微信號';
$_LANG['expand'] = '展開';
$_LANG['collapse'] = '收起';
$_LANG['confirm_unbind'] = '您確定要解除綁定嗎？';
$_LANG['use_shopex_acc'] = '解除綁定後請用ECshop賬號';
$_LANG['login'] = '登錄';
$_LANG['confirm'] = '確認';
$_LANG['cancel'] = '取消';
$_LANG['unbind_success'] = '解綁成功';
$_LANG['has_bind'] = '已綁定';
$_LANG['un_bind'] = '解綁';
$_LANG['associate_wechat'] = '您正在使用ecshop賬號關聯微信賬號';
$_LANG['mind_account'] = '請您牢記該ECshop賬號';
$_LANG['unbind_des'] = '解綁後需要使用此賬號進行登錄，解綁後的賬號仍可正常使用，訂單等信息不會丟失，忘記密碼請在登錄頁找回密碼';
$_LANG['associate_des'] = '該賬號下關聯微信賬號將全部解綁';
/* 會員餘額(預付款) */
...
$_LANG['surplus_amount'] = '您的充值金額爲：';
$_LANG['payment_name'] = '您選擇的支付方式爲：';
$_LANG['payment_fee'] = '支付手續費用爲：';
$_LANG['payment_desc'] = '支付方式描述：';
$_LANG['current_surplus'] = '您當前的可用資金爲：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '贈品免費';
$_LANG['surplus_amount_error'] = '您要申請提現的金額超過了您現有的餘額，此操作將不可進行！';
$_LANG['surplus_appl_submit'] = '您的提現申請已成功提交，請等待管理員的審覈！';
...
$_LANG['profile_js']['msg_blank'] = '不能爲空';
...
$_LANG['get_question_username'] = '請輸入您註冊的用戶名以取得您的密碼提示問題。';
...
$_LANG['confirm_cancel'] = '您確認要取消該訂單嗎？取消後此訂單將視爲無效訂單';
$_LANG['merge_ok'] = '訂單合併成功！';
$_LANG['merge_invalid_order'] = '對不起，您選擇合併的訂單不允許進行合併的操作。';
$_LANG['select'] = '請選擇...';
$_LANG['order_not_pay'] = "你的訂單狀態爲 %s ,不需要付款";
$_LANG['order_sn_empty'] = '合併主訂單號不能爲空';
$_LANG['merge_order_notice'] = '訂單合併是在發貨前將相同狀態的訂單合併成一新的訂單。<br />收貨地址，送貨方式等以主定單爲準。';
...
$_LANG['merge'] = '合併';
$_LANG['notice_order_sn'] = '當兩個訂單不一致時，合併後的訂單信息（如：支付方式、配送方式、包裝、賀卡、紅包等）以第二個爲準。';
$_LANG['subtotal'] = '小計';
...
$_LANG['passport_js']['msg_un_blank'] = '* 用戶名不能爲空';
...
$_LANG['passport_js']['msg_email_blank'] = '* 郵件地址不能爲空';
$_LANG['passport_js']['msg_email_registered'] = '* 郵箱已存在,請重新輸入';
$_LANG['passport_js']['msg_email_format'] = '* 郵件地址不合法';
$_LANG['passport_js']['msg_blank'] = '不能爲空';
$_LANG['passport_js']['no_select_question'] = '- 您沒有完成密碼提示問題的操作';
$_LANG['passport_js']['passwd_balnk'] = '- 密碼中不能包含空格';


/* user_clips.dwt js 語言文件 */
$_LANG['clips_js']['msg_title_empty'] = '留言標題爲空';
$_LANG['clips_js']['msg_content_empty'] = '留言內容爲空';
...
/* 保存用戶訂單收貨地址 */
$_LANG['consigness_empty'] = '收貨人姓名爲空';
$_LANG['address_empty'] = '收貨地址詳情爲空';
...
$_LANG['firefox_copy_alert'] = "您的firefox安全限制限制您進行剪貼板操作，請打開’about:config’將signed.applets.codebase_principal_support’設置爲true’之後重試";
...
$_LANG['affiliate_intro'][0] = '　　本網店爲鼓勵推薦新用戶註冊，現開展<b>推薦註冊分成</b>活動，活動流程如下：

　　１、將本站提供給您的推薦代碼，發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
　　３、在訪問者點擊鏈接的 <b>%d%s</b> 內，若該訪問者在本站註冊，即認定該用戶是您推薦的，您將獲得等級積分 <b>%d</b> 的獎勵 (當您的等級積分超過 <b>%d</b> 時，不再獲得獎勵)。
　　４、該用戶今後在本站的一切消費，您均能獲得一定比例的提成。目前實行的提成總額爲訂單金額的 <b>%s</b> 、積分的 <b>%s</b> ，分配給您、推薦您的人等，具體分配規則請參閱 <b><a href="#myrecommend">我推薦的會員</a></b>。
　　５、提成由管理員人工審覈發放，請您耐心等待。
　　６、您可以通過分成明細來查看您的介紹、分成情況。';
$_LANG['affiliate_intro'][1] = '　　本網店爲鼓勵推薦新用戶註冊，現開展<b>推薦訂單分成</b>活動，活動流程如下：
...
$_LANG['affiliate_qrcode'] = '二維碼';
$_LANG['affiliate_qrcode_share_text'] = '微信掃一掃，快速分享！';
...
$_LANG['user_reg_info'][2] = '不註冊爲會員也可在本店購買商品';
$_LANG['user_reg_info'][8] = '不註冊爲會員不可以在本店購買商品';
...
$_LANG['invalid_captcha_config'] = '騰訊雲驗證碼配置不正確。';
?>
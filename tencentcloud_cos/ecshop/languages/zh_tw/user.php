...
$_LANG['booking_js']['email_empty'] = '請輸入聯繫人的郵箱！';
$_LANG['booking_js']['email_error'] = '您輸入的郵箱格式不正確！';
...
$_LANG['edit_address_success'] = '您的收貨地址信息更新成功！';
$_LANG['address_list_lnk'] = '返回地址列表';
$_LANG['add_address'] = '添加貨地址';
$_LANG['confirm_edit'] = '確認修改';

$_LANG['confirm_drop_address'] = '您確定要刪除該收貨地址嗎？';

/* 會員密碼找回 */
$_LANG['username_and_email'] = '請輸入您註冊的用戶名和註冊時填寫的郵箱！';
$_LANG['enter_new_password'] = '請輸入您的新密碼！';
$_LANG['username_no_email'] = '您填寫的用戶名與郵箱不匹配，請重新輸入！';
...
$_LANG['username_not_match_email'] = '用戶名與郵箱不匹配，請重新輸入！';
...
$_LANG['wrong_passwd_answer'] = '您輸入的密碼答案不正確！';

//JS語言項
$_LANG['password_js']['user_name_empty'] = '請輸入您的用戶名！';
$_LANG['password_js']['email_address_empty'] = '請輸入您的郵箱！';
$_LANG['password_js']['email_address_error'] = '您輸入的郵箱格式不正確！';
...
$_LANG['confirm_cancel'] = '取消後此訂單將視為無效訂單，您確認要取消該訂單嗎？';
$_LANG['merge_ok'] = '訂單合併成功！';
$_LANG['merge_invalid_order'] = '對不起，您選擇合併的訂單不允許進行合併的操作。';
$_LANG['select'] = '請選擇...';
$_LANG['order_not_pay'] = "您的訂單狀態為 %s ,不需要付款";
...
$_LANG['get_password_by_mail'] = '註冊郵箱找回密碼';
...
$_LANG['msg_un_registered'] = '用戶名已經存在,請更換！';
$_LANG['msg_can_rg'] = '可以註冊';
$_LANG['msg_email_blank'] = '郵箱不能為空！';
$_LANG['msg_email_registered'] = '郵箱已存在,請更換！';
$_LANG['msg_email_format'] = '郵箱格式不正確！';
...
$_LANG['email_empty'] = '郵箱不能為空！';
$_LANG['email_invalid'] = '%s 不是合法的郵箱格式！';
$_LANG['email_exist'] = '%s 已經存在！';
$_LANG['email_not_allow'] = '郵箱 %s 不允許註冊！';
...
$_LANG['passport_js']['email_empty'] = '- 郵箱為空！';
$_LANG['passport_js']['email_invalid'] = '- 郵箱格式不正確！';
...
$_LANG['passport_js']['msg_un_registered'] = '* 用戶名已經存在,請更換！';
$_LANG['passport_js']['msg_can_rg'] = '* 可以註冊';
$_LANG['passport_js']['msg_email_blank'] = '* 郵箱不能為空！';
$_LANG['passport_js']['msg_email_registered'] = '* 郵箱已存在,請更換！';
$_LANG['passport_js']['msg_email_format'] = '* 郵箱格式不正確！';
...
/* 保存用戶訂單收貨地址 */
$_LANG['consigness_empty'] = '收貨人姓名不能為空！';
$_LANG['address_empty'] = '收貨地址詳情不能為空！';
...
$_LANG['affiliate_qrcode_share_text'] = '微信掃壹掃，快速分享！';
...
$_LANG['validate_ok'] = '%s 您好，您郵箱 %s 已通過驗證！';
...
$_LANG['show_good_to_you'] = '推薦給您一個好物品';

/* 積分兌換 */
$_LANG['transform_points'] = '積分兌換';
$_LANG['invalid_points'] = '您輸入的積分是不一個合法值！';
$_LANG['invalid_input'] = '無效';
$_LANG['overflow_points'] = '您輸入的兌換積分超過您的當前積分！';
$_LANG['to_pay_points'] = '恭喜，您%s論壇%s兌換了%s的商城消費積分';
$_LANG['to_rank_points'] = '恭喜，您%s論壇%s兌換了%s的商城等級積分';
$_LANG['from_pay_points'] = '恭喜，您%s的商城消費積分兌換%s論壇%s';
$_LANG['from_rank_points'] = '恭喜，您%s論壇%s兌換了%s的商城消費積分';
...
$_LANG['exchange_success'] = '恭喜，您用%s個%s兌換了%s個%s';

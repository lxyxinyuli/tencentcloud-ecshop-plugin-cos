...
$modules['18_lead_manage']['logo_other'] = 'mobile_setting.php?act=logo_other'; //首页外logo设置
...
$modules['19_tencent_plugins']['1tencent_center']         = 'tencent_center.php?act=list_edit';//公共配置
$modules['19_tencent_plugins']['2tencent_captcha']         = 'tencent_captcha.php?act=list_edit';//验证码配置
$modules['19_tencent_plugins']['3tencent_cos']         = 'tencent_cos.php?act=list_edit';//对象存储配置

 ...
 * @return bool
 */
function is_cos_enable()
{
    $cos_options = get_cos_options();
    return !empty($cos_options) && $cos_options['switch'] === '1' && $cos_options['remote_url'] != "";
}

function get_cos_options()
{
    return isset($GLOBALS['_CFG']['cos_plugin']) ? json_decode($GLOBALS['_CFG']['cos_plugin'], true) : array();
}
